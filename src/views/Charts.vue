        ...
        async checkOut() {
            if (this.form.nama && this.form.nomor_meja) {
                ...
                if (res.ok) {
                    ...
                    Promise.all(this.listCharts.map(async (item) => {
...
<template>
    <main class="max-w-desk w-full mx-auto px-5">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-white md:ml-2">Keranjang</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div v-if="listCharts.length === 0" class="flex flex-col justify-center items-center h-40">
        ...
        <div v-else>
            <div className="overflow-x-auto mt-5">
                <table class="w-max min-w-full">
                    ...
                    <tbody>
                        <tr v-for="(item, key) in listCharts" :key="key" class="border-b">
                            ...
                            <td class="font-semibold px-4"><i
                                    class="bi bi-trash text-white hover:text-red-500 hover-anim cursor-pointer"
            ...
            <div class="flex justify-end mt-8 md:mt-10 mb-8">
