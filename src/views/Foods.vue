    ...
    <main class="max-w-desk w-full mx-auto padding">
        ...
        <div class="relative my-7">
            ...
            <input type="text" :value="search" @input="_handleSearch"
                class="input-style px-14 py-2 w-full"
                placeholder="Cari makanan kesukaan anda.." />
            <i class="bi bi-x-circle absolute top-1.5 right-5 text-lg hover:text-red-500 dark:hover:text-white cursor-pointer hover-anim"
